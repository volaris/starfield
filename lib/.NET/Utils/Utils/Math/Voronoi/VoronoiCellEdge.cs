...
namespace VoronoiNS
{
    public class VoronoiCellEdge
    {
        ...
        public void AddVertex(VoronoiCellVertex vertex)
        {
            ...
            {
                Debugger.Log(0, "[ERROR]", "Impossible: an edge can only have 2 vertices, not 3!");
                return;
            }
        ...
        */
        public void AddCellWithSideEffects(VoronoiCell c)
        {
            ...
            {
                Debugger.Log(0, "[ERROR]", "Cannot add a third cell to an edge!");
                return;
            }
            ...
            {
                Debugger.Log(0, "[ERROR]", "Fail: this edge has one or both edgeVertex nodes missing; cannot continue");
                return;
            }
            else
            {
