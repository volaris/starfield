...
{
    /** <summary>    Simplex noise based columns and curtains. </summary> */
    [DriverType(DriverTypes.Experimental)]
    public class SimplexColumnsAndCurtains : IStarfieldDriver
    {
        ...
        /**
         * <summary>    Gets or sets a value indicating whether or not to fade the edges. </summary>
         *
        ...
        /**
         * <summary>    Gets or sets a value indicating whether or not to render in high contrast (single color). </summary>
         *
